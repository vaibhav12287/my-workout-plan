...
const MEALS_BY_DAY = {
  0: [
    ...
    },
    {
      ...
      color: C.blue,
      items: [
        "OPTION A — Paneer Chilla (15 min): besan + water + salt + ajwain batter, 75g crumbled paneer stuffed inside, cook on tawa. 150g dahi + green chutney on side.",
        "OPTION B — Paneer Stuffed Paratha (10 min): whole wheat dough, 75g crumbled paneer + jeera + red chilli stuffing, 1 tsp ghee on tawa. Dahi on side.",
        "OPTION C — Order out: Any dhaba paneer paratha + dahi. Most dhabas Rs 80-120.",
        "5 soaked walnuts on side",
        "~600 kcal | 38g protein | 58g carbs",
      ],
      why: "Both options use ingredients always available at home — besan, atta, paneer, dahi. No imported ingredients. Filling, high protein, tastes great. Alternate weeks do regular dal + sabzi.",
    },
    {
      label: "DINNER — Paneer Poke Bowl",
      color: C.purple,
      items: [
        ...
        "1/2 cup edamame — boil from frozen 3 min",
        "1 cucumber — sliced",
        "1 carrot — julienned",
  ...
  3: [
    ...
    },
    {
      ...
      color: C.blue,
      items: [
        "OPTION A — Order Salad Days (Udyog Vihar) or Green Bunz (Sector 31) on Zomato: BYOS quinoa + paneer + chickpeas + olive oil lemon dressing + dahi",
        "OPTION B — Home Chole Chawal (15 min if chole pre-soaked): 1 cup chole + brown rice + raw onion + lemon + green chilli. Light on stomach, high protein.",
        "OPTION C — Dhaba Plate: dal + 1 roti + dahi. Keep it small — badminton evening.",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "1/2 cup edamame — boil frozen edamame 3 min in salted water (Big Basket frozen section)",
...
const GROCERY = [
  ...
  "Edamame frozen (200g) — Monday dinner + Sunday poke bowl (Big Basket)",
